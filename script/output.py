...
def siglas(ax, r):
    if r == "NNE" or r == "BR":
        for k, v in pos_siglas.items():
            ax.text(v[1], v[0], k, color='#4F4F4F', zorder=5)
    ...
    if r == "NNE":
        ax.text(-36.2, 5, "Oceano Atlântico", color='#4F4F4F',
                fontstyle='italic', fontsize=20, zorder=5)

    elif r == "SSE" or r == "BR":
        ax.text(-37.2, -36.5, "Oceano Atlântico", color='#4F4F4F',
                fontstyle='italic', fontsize=20, zorder=5)


def continente(ax, zee_color='grey'):

    SHP_ZEE = Reader("shps/ZEE/ZEE.shp").geometries()

    ax.add_geometries(SHP_ZEE, ccrs.PlateCarree(), linewidth=1,
    ...
    ax.coastlines(resolution='50m', color='grey', linewidth=.25)
...
def plota_area(lats, lons, nome_arq, dir_):
    ...
    plt.savefig(path_output + dir_ + nome_arq + ".png", bbox_inches='tight')
    plt.show()


def plota_ts(lats, lons, times, wpd, spd, format, xlabel, nome_arq, dir_):
    ...
    for lat, lon in latlon_points.items():
        ...
        plt.savefig('{}{}{}_p{}.png'.format(path_output, dir_, nome_arq, pt),
...
def plota_ts2(lats, lons, times, wpd, spd, format, xlabel, nome_arq, dir_):
...
def plota_mapa(lats, lons, data, nome_arq, dir_, zee_color='red', u=[], v=[]):
    ...
    elif "Capacity" in str(nome_arq) or "Availability" in str(nome_arq) or \
         "Complements" in str(nome_arq) or "Synergy" in str(nome_arq):
        levels = np.arange(0, 100.1, 10)
        cmap, label = "inferno", "%"

    elif "WPD" in str(nome_arq):
        levels = np.arange(0, 1101, 100)
        cmap, label = "afmhot_r", "W/m²"

    elif "SPD" in str(nome_arq):
...
def plota_mapa_anual(lats, lons, data, nome_arq, dir_, zee_color, u=[], v=[]):
    ...
    ax7 = fig.add_subplot(gs[1, 1], projection=ccrs.PlateCarree())
    ax8 = fig.add_subplot(gs[1, 2], projection=ccrs.PlateCarree())
    ax9 = fig.add_subplot(gs[1, 3], projection=ccrs.PlateCarree())
    ax10 = fig.add_subplot(gs[1, 4], projection=ccrs.PlateCarree())
    ax11 = fig.add_subplot(gs[2, 0], projection=ccrs.PlateCarree())
    ax12 = fig.add_subplot(gs[2, 1], projection=ccrs.PlateCarree())
    ax13 = fig.add_subplot(gs[2, 2], projection=ccrs.PlateCarree())
    ax14 = fig.add_subplot(gs[2, 3], projection=ccrs.PlateCarree())
    ax15 = fig.add_subplot(gs[2, 4], projection=ccrs.PlateCarree())
    ax16 = fig.add_subplot(gs[3, 0], projection=ccrs.PlateCarree())
    ax17 = fig.add_subplot(gs[3, 1], projection=ccrs.PlateCarree())
    ax18 = fig.add_subplot(gs[3, 2], projection=ccrs.PlateCarree())
    ax19 = fig.add_subplot(gs[3, 3], projection=ccrs.PlateCarree())
    ax20 = fig.add_subplot(gs[3, 4], projection=ccrs.PlateCarree())
    ax21 = fig.add_subplot(gs[4, 0], projection=ccrs.PlateCarree())
    ax22 = fig.add_subplot(gs[4, 1], projection=ccrs.PlateCarree())
    ax23 = fig.add_subplot(gs[4, 2], projection=ccrs.PlateCarree())
    ax24 = fig.add_subplot(gs[4, 3], projection=ccrs.PlateCarree())
    ax25 = fig.add_subplot(gs[4, 4], projection=ccrs.PlateCarree())
    ax26 = fig.add_subplot(gs[5, 0], projection=ccrs.PlateCarree())
    ax27 = fig.add_subplot(gs[5, 1], projection=ccrs.PlateCarree())
    ax28 = fig.add_subplot(gs[5, 2], projection=ccrs.PlateCarree())
    ax29 = fig.add_subplot(gs[5, 3], projection=ccrs.PlateCarree())
    ax30 = fig.add_subplot(gs[5, 4], projection=ccrs.PlateCarree())
...
def plota_mapa_monthly(lats, lons, data, nome_arq, dir_, zee_color='red',
                       u=[], v=[]):
    ...
    ax10 = fig.add_subplot(gs[3, 0], projection=ccrs.PlateCarree())
    ax11 = fig.add_subplot(gs[3, 1], projection=ccrs.PlateCarree())
    ax12 = fig.add_subplot(gs[3, 2], projection=ccrs.PlateCarree())
...
def plota_mapa_hourly(lats, lons, data, nome_arq, dir_, zee_color, u=[], v=[]):
...
def plota_mapa_tecnico_regiao(pontos_dentro, bar_dentro, bounds=None):
    ...
    # ax.add_geometries(SHP_AS, ccrs.PlateCarree(), facecolor="silver",
    #                   edgecolor="gray", zorder=3.1, linewidth=0.4)
    # ax.add_geometries(SHP_BRASIL, ccrs.PlateCarree(
    # ), facecolor="none", edgecolor="gray", zorder=3.1, linewidth=0.4)
    # ax.add_geometries(SHP_BATIMETRIA1000, ccrs.PlateCarree(),
    #                   facecolor="#483D8B", edgecolor="black", zorder=2.9,
    #                   linewidth=0.5)
    # ax.add_geometries(SHP_UC, ccrs.PlateCarree(), facecolor="#32CD32",
    #                   edgecolor="#32CD32", zorder=3, linewidth=0.5)
    # ax.add_geometries(SHP_DIF, ccrs.PlateCarree(), facecolor="#90EE90",
    #                   edgecolor="black", zorder=3, linewidth=0.5)
    ...
    # ax.contourf(lons, lats, ws7, levels=levels2, cmap=cmap2,
    #             transform=ccrs.PlateCarree(), zorder=3)

    # cmap3 = ListedColormap(["red","red"])
    # ax.contourf(lons, lats, ROCI113, levels=levels2, cmap=cmap3,
    #             transform=ccrs.PlateCarree(), zorder=3)

    # ax.add_geometries(SHP_18KM, ccrs.PlateCarree(), facecolor="#4c1130",
...
def plota_grid():
    ...
    # ax.add_geometries(SHP_DIF, ccrs.PlateCarree(), facecolor="#bee8ff",
